...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        for i in range(len(all_vowels)//2):
            ...
            mapping_dict[VOWELS_UPPER[i]] = vowels_permutation.upper()[i]
    ...
    def apply_transpose(self, transpose_dict):
        ...
        all_letters = CONSONANTS_LOWER + CONSONANTS_UPPER + VOWELS_LOWER + VOWELS_UPPER
        message = list(self.get_message_text())
        for i in range(len(message)):
            if message[i] in all_letters:
                message[i] = transpose_dict[message[i]]
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        for permutation in get_permutations(VOWELS_LOWER):            
            text_list = self.apply_transpose(self.build_transpose_dict(permutation)).split(' ', 1)
            temp = 0
...
if __name__ == '__main__':
    ...
    message2 = SubMessage("A different word!")
    permutation2 = "oueia" 
    ...
    print("Expected encryption:", "O deffurunt wird!")
